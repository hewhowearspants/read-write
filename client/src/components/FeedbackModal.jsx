        ...
        <div className='feedback-modal'>
          ...
          <form>
            <div className='rating'>
              ...
              <label className="star star-1" for="star-1">1</label> 
            </div>
